...
def inject_phase2_panel(html_bytes: bytes) -> bytes:
    ...
    if not html_bytes:
        return html_bytes
    # The MicroBilt compliance card is NATIVE in app.html
    # (renderComplianceCard, Profile tab) — an injected version was tried
    # and removed 2026-07-06: it targeted DOM anchors the 2026-07 detail
    # overhaul had deleted and never rendered. Don't reintroduce
    # runtime-anchor injection for new features.
